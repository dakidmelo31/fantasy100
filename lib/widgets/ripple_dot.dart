...
class RippleDot extends StatefulWidget {
  const RippleDot({Key? key}) : super(key: key);

  @override
  _RippleDotState createState() => _RippleDotState();
}

class _RippleDotState extends State<RippleDot> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    secondRippleRadiusAnimation = Tween<double>(begin: 0, end: 30).animate(
      CurvedAnimation(
    ...
    secondRippleWidthAnimation = Tween<double>(begin: 5, end: 0).animate(
      CurvedAnimation(
        parent: secondRippleController,
        curve: Curves.ease,
      ),
    ...
    thirdRippleRadiusAnimation = Tween<double>(begin: 0, end: 20).animate(
      CurvedAnimation(
    ...
    thirdRippleWidthAnimation = Tween<double>(begin: 5, end: 0).animate(
      CurvedAnimation(
        parent: thirdRippleController,
        curve: Curves.ease,
      ),
    ...
    centerCircleRadiusAnimation = Tween<double>(begin: 10, end: 25).animate(
      CurvedAnimation(
...
class MyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Color myColor = Color.fromARGB(255, 86, 245, 12);
